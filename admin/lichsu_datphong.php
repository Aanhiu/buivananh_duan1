    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                <h3 class="mb-4">Admin -Quản lí lịch sử đặt phòng</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($row['trangthai'] == 8) : ?>
                                                    ...
                                                    <a href="?delete=<?php echo $row['id']; ?>" onclick="return confirm('Bạn có chắc muốn xóa lịch sử đặt phòng này không?')" class="btn btn-danger btn-sm">Xóa Lịch sử</a>
                                                    <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
